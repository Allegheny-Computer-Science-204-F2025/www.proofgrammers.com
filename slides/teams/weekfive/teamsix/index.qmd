...
- By contrasting *static* (structure-based) and *dynamic* (output-based) analysis,  
  we gain insight into why some problems are computable while others are not.  
- Ultimately, `startsWithZ` reminds us of the **limits of computation**  
  and the power of **proof by contradiction**. 
:::
